...
internal static class Stegano
{
    ...
    {
        int c = (int)(bitmap.GetPixel(x, y).G & 0xF8);
        int u = (int)(bitmap.GetPixel(x, y - 1).G & 0xF8);
        int d = (int)(bitmap.GetPixel(x, y + 1).G & 0xF8);
        int l = (int)(bitmap.GetPixel(x - 1, y).G & 0xF8);
        int r = (int)(bitmap.GetPixel(x + 1, y).G & 0xF8);
